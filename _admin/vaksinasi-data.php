<div class="wrapper wrapper-content animated fadeInRight" style="zoom: 0.88; padding: 10">
    <div class="row">
        <div class="col-lg-12">
        <?php 
                ...
                <div class="ibox-content" style="padding: 10">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-examples" >
                            ...
                            <?php
                            include '../koneksi.php';
                            $sql = "SELECT * FROM vaksinasi,user,product,plasma,customer WHERE vaksinasi.pelaksana = user.uid AND vaksinasi.stockcode=product.stockcode AND vaksinasi.plasmacode = plasma.plasmacode AND plasma.custcode = customer.custcode AND vaksinasi.reschedule IS NULL AND vaksinasi.cancel IS NULL ORDER BY tanggal DESC, vacid DESC";

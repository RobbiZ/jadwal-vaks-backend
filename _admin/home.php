...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> 
                        ...
                        <span class="clear">
                            ...
                            <span class="text-muted text-xs block">Database Admin</span>
                        </span>
                        </a>
                    </div>
                ...
                <li id="customer-data">
                    <a href="home.php?hal=customer-data"><i class="fa fa-cog"></i> <span class="nav-label">Data Customer</span></a>
                </li>
                <li id="plasma-data">
                    <a href="home.php?hal=plasma-data"><i class="fa fa-cogs"></i> <span class="nav-label">Data Plasma</span></a>
                </li>
                <li id="user-data">
                    <a href="home.php?hal=user-data"><i class="fa fa-user"></i> <span class="nav-label">Data User</span></a>
                </li>
                <li id="product-data">
                    <a href="home.php?hal=product-data"><i class="fa fa-leaf"></i> <span class="nav-label">Data Product</span></a>
                </li>
                <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        <div class="row border-bottom" style="padding: 0">
        ...
        <div class="wrapper wrapper-content" style="padding-top: 0; padding-left: 0; padding-right: 0">
            <?php
                error_reporting(0);
                $halaman = $_GET['hal'];
                switch ($halaman) {

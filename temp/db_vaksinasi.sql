...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2018 at 06:54 PM
...
ALTER TABLE `product`
  ...
  ADD UNIQUE KEY `description` (`productname`);
...
ALTER TABLE `vaksinasi`
  ...
  ADD KEY `plasmacode` (`plasmacode`,`stockcode`,`pelaksana`),
  ADD KEY `pelaksana` (`pelaksana`),
...
--
ALTER TABLE `vaksinasi`
  MODIFY `vacid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
